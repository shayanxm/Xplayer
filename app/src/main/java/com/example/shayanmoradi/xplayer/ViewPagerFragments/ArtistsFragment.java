...
import com.example.shayanmoradi.xplayer.Models.Artist;
import com.example.shayanmoradi.xplayer.Models.ArtistLab;
  ...
  MyRecyclerViewAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // List<Album> albums = AlbumLab.getInstance(getActivity()).getListOfAlbums();
        List<Artist>artists= ArtistLab.getInstance(getActivity()).getListOfArtists();
...
//Toast.makeText(getActivity(),albums.size()+"",Toast.LENGTH_SHORT).show();
        ...
        adapter = new MyRecyclerViewAdapter(getActivity(), artists);
    ...
    public class MyRecyclerViewAdapter extends RecyclerView.Adapter<MyRecyclerViewAdapter.ViewHolder> {
        ...
        MyRecyclerViewAdapter(Context context, List<Artist> data) {
        ...
        public MyRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = mInflater.inflate(R.layout.meterial_card_view_artists, parent, false);
        ...
        public void onBindViewHolder(MyRecyclerViewAdapter.ViewHolder holder, int position) {
            ...
            Artist album = mData.get(position);

            holder.myTextView.setText(album.getmArtistNAme());
...
//                        startActivity(intent);
                        ...
                        ControlArtistFragment detailFragment = ControlArtistFragment.newInstance(album.getmArtistNAme(),true);
